...
public class Encryption 
{
	 ...
	 * 
	 */
	public String encrypt(String clear) throws IOException, IllegalBlockSizeException, BadPaddingException 
	{
		InputStream inStream = new ByteArrayInputStream(clear.getBytes("UTF-8"));
	 ...
	 * 
	 */
	public String decrypt(String cipher) throws IllegalBlockSizeException, BadPaddingException, IOException 
	{
		InputStream inStream = new ByteArrayInputStream(java.util.Base64.getDecoder().decode(cipher));
		OutputStream outStream = new ByteArrayOutputStream();
